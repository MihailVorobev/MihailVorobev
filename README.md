...
-Основами тестирования
-Видами и уровнями тестирования
-Принципами тестирования
-Оценкой и анализом места тестирования в жизненном цикле ПО
-Сутью, целями и задачами тестирования
-Тестированием Web и DeskTop приложений
-Составление тех.документации(чек-лист, тест-кейс)
-Занесением дефектов 
-Применением основных техник тест-дизайна
-Анализом процессов разработки ПО
-Изучением HTML, CSS
-Кратким курсрм основных запросов в SQL
